...
//Basic usage
const greeting = `New, world`;

//String interploation
const username = "Mom";
const welcomeMessage = `New, ${username}! welcome to our website`;
...
//Basic usage
const sentences = "New,world";
const index = sentences.indexOf("New");
